...
exports.resetPassword = catchAsyncErrors(async(req, res, next) => {
    ...
    if(!user){
        return next(new ErrorHandler("Reset password url is invalid or has benn expried", 400));
...
exports.updateShippingInfo = catchAsyncErrors(async(req, res, next) => {
    const newUserData = {
        ...
        shippingInfo: {
            ...
            cep: req.body.shippingInfo.cep,
            number: req.body.shippingInfo.number,
